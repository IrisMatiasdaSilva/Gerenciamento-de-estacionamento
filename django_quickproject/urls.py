...
from estacionamento.api.views import CleinteViewSet, VeiculoViewSet, EstacionamentoViewSet

router = SimpleRouter()

router.register("users", UserProfileExampleViewSet, basename="users")
router.register("cliente", CleinteViewSet, basename="cliente")
router.register("veiculo", VeiculoViewSet, basename="veiculo")
router.register("estacionamento", EstacionamentoViewSet, basename="estacionamento")
